...
export class ScalesTheoryElement extends LitElement {
  ...
  renderNameDisclaimer() {
    return this.renderRow(html`
      <figure class="text-center">
        <blockquote class="blockquote">
          <p>
            Για λόγους ευκολίας, όλα μπορεί να αναφέρονται παρακάτω ως "τετράχορδα", ώστε να
            αποφευχθεί η επαναλαμβανόμενη χρήση του όρου "πεντάχορδα-τετράχορδα".
          </p>
        </blockquote>
      </figure>
    `);
  ...
  renderKyriaKaiDefterevontaTetraxorda() {
    return this.renderRowWithTitle(
      "Κύρια και δευτερεύοντα τετράχορδα",
      html`<ul>
        <li>
          Σε έναν δρόμο, <strong>κύριο</strong> θεωρείται το πρώτο τετράχορδο και
          <strong>δευτερεύον</strong> το δεύτερο.
        </li>
      </ul>`
    );
  }
  ...
  render() {
    return html`
      <div class="container">
        ...
        <div />
        ${this.renderNameDisclaimer()}
        <div />
        ${this.renderListaTetraxordon()}
        <div />
        ${this.renderMetatropi()}
        <div />
        ${this.renderKyriaKaiDefterevontaTetraxorda()}
        <div />
